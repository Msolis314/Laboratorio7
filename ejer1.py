...
def main():
    args = arguments()
    id_p = args.id
    print("Nombre:" ,os.system(f"ps -p {id_p} -o comm="))
    print( "Parent process id:",os.system(f" ps -p {id_p} -o pid="))
    print("Usuario propetario:", os.system(f" ps -p {id_p} -o user="))
    print("Porcentaje de uso de CPU:",os.system(f" ps -p {id_p} -o %cpu="))
    print("Consumo de memoria:", os.system(f" ps -p {id_p} -o %mem="))
